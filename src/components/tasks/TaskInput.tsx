    ...
    >
      ...
      <View className="flex-row flex-wrap items-center justify-between gap-4 border-t border-leben-border pt-4 mt-2">
        <View className="flex-row items-center gap-2">
          {/* Tag Selector */}
          <View className="flex-row items-center gap-1.5 p-1 rounded-lg border border-leben-border-subtle bg-leben-bg">
          ...
          <TouchableOpacity
            ...
            className="flex-row items-center gap-1 p-1.5 bg-leben-bg rounded-lg border border-leben-border"
          >
            <Text className="text-leben-text-muted text-[10px]">
              {reminderAt
        ...
        <TouchableOpacity
          ...
          className={`flex-row items-center justify-center gap-2 px-4 py-2 rounded-xl border ${
            task.trim()
              ...
              : "bg-transparent border-leben-border opacity-50"
          }`}
        >
          <Text
          ...
          <Text className={task.trim() ? "text-white" : "text-leben-text-dim"}>
            +
          </Text>
        </TouchableOpacity>
      </View>
