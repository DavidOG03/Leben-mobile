...
import Svg, { Circle, Line, Path, Polygon, Rect, G } from "react-native-svg";
...
export const ProfileIcon = ({
  ...
  <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
    ...
    <Path
      fill={color}
      d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74c.08-.01.16-.01.22 0h.07a4.74 4.74 0 0 0 4.58-4.74C16.75 4.13 14.62 2 12 2m5.08 12.15c-2.79-1.86-7.34-1.86-10.15 0c-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22s3.68-.47 5.08-1.41c1.26-.85 1.96-1.99 1.96-3.23c-.01-1.23-.7-2.37-1.96-3.21"
    />
  </Svg>
);
export const SyncingIcon = ({
  ...
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <Path fill={color} d="M11.675 21q-1.825-.025-3.4-.35t-2.75-.862t-1.85-1.25T3 17q0 .825.675 1.537t1.85 1.25t2.75.863t3.4.35m-.375-5q-.95-.05-1.838-.162t-1.687-.3t-1.5-.438T5 14.525q.575.325 1.275.575t1.5.438t1.688.3T11.3 16m.7-6.975q2.225 0 4.475-.663T19 7.025q-.275-.725-2.512-1.375T12 5q-2.275 0-4.462.638T5 7.025q.35.675 2.538 1.338T12 9.025M17.5 21h1v-4.1l1.8 1.8l.7-.7l-3-3l-3 3l.7.7l1.8-1.8zm-3.037.538Q13 20.075 13 18t1.463-3.537T18 13t3.538 1.463T23 18t-1.463 3.538T18 23t-3.537-1.463m-3.388-2.562q.075.55.225 1.05t.375.975q-1.825-.025-3.4-.35t-2.75-.862t-1.85-1.25T3 17V7q0-1.65 2.638-2.825T12 3t6.363 1.175T21 7v4.675q-.475-.225-.975-.375T19 11.075v-1.55q-1.3.725-3.1 1.1T12 11q-2.125 0-3.925-.375T5 9.525v2.525q1.275 1.175 3.262 1.563T12 14h.275q-.325.45-.562.95T11.3 16q-1.9-.1-3.525-.462T5 14.525V17q.175.325.75.663t1.4.6t1.838.45t2.087.262" />
  </Svg>
);

export const SyncCompleteIcon = ({
  color = "currentColor",
  size = 20,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <Path fill={color} d="M12 10c4.418 0 8-1.79 8-4s-3.582-4-8-4s-8 1.79-8 4s3.582 4 8 4m6.328.17A7.6 7.6 0 0 0 20 9.053v2.445a6.5 6.5 0 0 0-7.209 10.482q-.39.02-.791.02c-4.418 0-8-1.79-8-4V9.053a7.6 7.6 0 0 0 1.672 1.117C7.37 11.018 9.608 11.5 12 11.5s4.63-.482 6.328-1.33M23 17.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0m-2.146-2.354a.5.5 0 0 0-.708 0L16.5 18.793l-1.646-1.647a.5.5 0 0 0-.708.708l2 2a.5.5 0 0 0 .708 0l4-4a.5.5 0 0 0 0-.708" />
  </Svg>
);
